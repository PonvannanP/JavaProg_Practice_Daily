...
public class Map_RealExample {
    public static void main(String[] args) {
        ...
        System.out.println(students);// List of two students will get printed


        System.out.println(student1);// student1 will get printed
        ...
        book_read_items.add("Atomic Habit");// Duplicate values are removed in Set
